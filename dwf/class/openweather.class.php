...
class openweather {
    ...
    private function get_weater_fr($id) {
        ...
        $weather = [
            ...
            302 => ["img" => $img . "09d.png", "text" => "Lourde brouillard"],
            ...
            313 => ["img" => $img . "09d.png", "text" => "Pluie intence et brouillard"],
            314 => ["img" => $img . "09d.png", "text" => "Lourde pluie intence et brouillard"],
            321 => ["img" => $img . "09d.png", "text" => "brouillard intence"],
            ...
            520 => ["img" => $img . "09d.png", "text" => "Pluie intence d'intensité légère"],
            521 => ["img" => $img . "09d.png", "text" => "Pluie intence"],
            522 => ["img" => $img . "09d.png", "text" => "Lourde pluie intence"],
            531 => ["img" => $img . "09d.png", "text" => "Pluie intence déchiquetée"],
            ...
            612 => ["img" => $img . "13d.png", "text" => "Neige fondue intence"],
            615 => ["img" => $img . "13d.png", "text" => "Pluie fine et neige"],
            616 => ["img" => $img . "13d.png", "text" => "Pleut et la neige"],
            620 => ["img" => $img . "13d.png", "text" => "Neige intence légère"],
            621 => ["img" => $img . "13d.png", "text" => "Neige intence"],
            622 => ["img" => $img . "13d.png", "text" => "Neige intence lourde"],
            701 => ["img" => $img . "50d.png", "text" => "Brume"],
            711 => ["img" => $img . "50d.png", "text" => "Fumée"],
            721 => ["img" => $img . "50d.png", "text" => "Brume"],
            731 => ["img" => $img . "50d.png", "text" => "Sable, tourbillons de poussière"],
