...
class docPHP_natives {
    ...
    public static function bunnyfonts() {
        ?>
        <p>Cette classe parmet de charger des fonts/polices en provenance de https://fonts.bunny.net</p>        
        <?php
        js::datatable();
        js::monaco_highlighter('<?php\n'
                . '//retourne la liste des fonts disponibles\n'
                . 'bunnyfonts::get_list();\n\n'
                . '//import une font simple (utilise le CDN de bunny font)\n'
                . 'bunnyfonts::import("amaranth:400,400i");\n'
                . '//ou avec l\'index de la font dans la liste\n'
                . 'bunnyfonts::import(bunnyfonts::get_list()[127]);\n'
                . '//import une font et sa version grasse\n'
                . 'bunnyfonts::import("amaranth:400,400i", "amaranth:700,700i");\n'
                . '//ou avec l\'index de la font dans la liste\n'
                . 'bunnyfonts::import(bunnyfonts::get_list()[127], bunnyfonts::get_list()[128]);\n\n'
                . '//téléchrage et délivre une font simple (la font deviens local)\n'
                . 'bunnyfonts::import_local("amaranth:400,400i");\n'
                . '//ou avec l\'index de la font dans la liste\n'
                . 'bunnyfonts::import_local(bunnyfonts::get_list()[127]);\n'
                . '//téléchrage et délivre une font et sa version grasse\n'
                . 'bunnyfonts::import_local("amaranth:400,400i", "amaranth:700,700i");\n'
                . '//ou avec l\'index de la font dans la liste\n'
                . 'bunnyfonts::import_local(bunnyfonts::get_list()[127], bunnyfonts::get_list()[128]);\n'
                . '?>');
        $data = [];
        foreach (bunnyfonts::get_list() as $id => $font) {
            $data[] = [$id, $font];
        }
        ?>
        <p class="alert alert-info my-3">Une fois appelé la font est disponible grace a une class CSS (helper) : <strong>.NomDeLaFont_Grassage</strong>. <br> 
            exemple : <strong>&lt;p class="amaranth_400&gtText d'exemple&lt;/p&gt;</strong>
        </p>
        <h3 class="text-center my-3">Liste des fonts disponible</h3>
        <?php
        echo html_structures::table(["Id", "Font"], $data, "", "datatable");
    }
    ...
    public static function check_PHPDoc() {
        ?>
        <p>Cette classe permet de vérifier la qualité et la complétude de la documentation PHPDoc d'un fichier PHP (classe uniquement).</p>
        <?php
        js::monaco_highlighter('<?php\n'
                . 'debug::print_r(check_PHPDoc::check_file("./index.php"));\n'
                . 'debug::print_r(check_PHPDoc::check_file("./class/docPHP.class.php"));\n'
                . '?>');
        echo "<p>Démonstration :</p>";
        echo "<p>Class bien documenté :</p>";
        debug::print_r(check_PHPDoc::check_file("./index.php"));
        echo "<p>Class mal documenté :</p>";
        debug::print_r(check_PHPDoc::check_file("./class/docPHP.class.php"));
        echo "<p>exemple de classe dont la documentation est conforme :</p>";
        js::monaco_highlighter('<?php\n'
                . '/**\n'
                . '* Description\n'
                . '* \n'
                . '* @author NOM Prenom <adresse@mail.com>\n'
                . '*/\n'
                . 'class exemple {\n\n'
                . '    /**\n'
                . '    * Description\n'
                ...
                . '    private $_attribut;\n\n'
                . '    /**\n'
                . '    * Description class / constructeur\n'
                . '    * @param type $attribut Description du parametre\n'
                . '    */\n'
                ...
                . '    /**\n'
                . '    * Description Methode\n'
                . '    * @param type $param Description du parametre\n'
                . '    * @return type Description du retour\n'
                . '    */\n'
                . '    public function une_methode($param) {\n'
                . '        return $param;\n'
                . '    }\n'
                . '}\n'
                . '?>');
