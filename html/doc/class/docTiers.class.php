...
class docTiers {
    ...
    public function __construct() {
        ...
        html_structures::table(["Librairie", "Version", "Auteur", "Langage", "Licence"], [
            ...
            [html_structures::a_link("https://js.cytoscape.org", "Cytoscape", "", "", true), "3.30.2", "The Cytoscape Consortium", "JS", $licences[10]],
            [html_structures::a_link("https://www.datatables.net", "Datatable", "", "", true), "2.1.8", "SpryMedia Limited", "JS", $licences[10]],
            ...
            [html_structures::a_link("https://github.com/dompdf/dompdf", "Dompdf", "", "", true), "3.0.0", "Benj Carson", "PHP", $licences[2]],
            ...
            [html_structures::a_link("https://fullcalendar.io", "Fullcalendar", "", "", true), "6.1.15", "Adam Shaw", "JS", $licences[0]],
            ...
            [html_structures::a_link("https://microsoft.github.io/monaco-editor/", "Monaco editor", "", "", true), "0.52.0", "Microsoft", "JS", $licences[0]],
            ...
            [html_structures::a_link("https://videojs.com/", "Videojs", "", "", true), "8.18.1", "Brightcove, Inc.", "JS", $licences[4]],
