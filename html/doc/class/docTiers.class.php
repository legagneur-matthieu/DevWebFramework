...
class docTiers {
    ...
    public function __construct() {
        ...
        html_structures::table(["Libairie", "Version", "Auteur", "Langage", "Licence"], [
            ...
            ["Animate", "3.7.2", "Daniel Eden", "JS", $licences[0]],
            ["Bootsrap", "4.3.1", "Twitter, Inc.", "CSS, JS", $licences[0]],
            ["Bootswatch", "4.3.1", "Thomas Park", "CSS", $licences[0]],
            ["Ckeditor", "4.13.1", "Frederico Knabben", "JS", $licences[1]],
            ["CSSTidy", "1.6.5", "Florian Schmitz", "PHP", $licences[2]],
            ["Cytoscape", "3.12.1", "The Cytoscape Consortium", "JS", $licences[10]],
            ...
            ["Flot", "3.0.0", "IOLA and Ole Laursen", "JS", $licences[0]],
            ...
            ["Leaflet", "1.6.0", "Vladimir Agafonkin, CloudMade", "JS", $licences[10] . ", OSMF"],
