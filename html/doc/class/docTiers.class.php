...
class docTiers {
    ...
    public function __construct() {
        ...
        html_structures::table(["Librairie", "Version", "Auteur", "Langage", "Licence"], [
            ...
            [html_structures::a_link("https://getbootstrap.com", "Bootsrap", "", "", true), "5.3.8", "Twitter, Inc.", "CSS, JS", $licences[0]],
            [html_structures::a_link("https://icons.getbootstrap.com", "Bootsrap Icons", "", "", true), "1.13.1", "Twitter, Inc.", "CSS", $licences[0]],
            [html_structures::a_link("https://bootswatch.com", "Bootswatch", "", "", true), "5.3.8", "Thomas Park", "CSS", $licences[0]],
            [html_structures::a_link("https://github.com/Gregwar/Captcha", "Captcha", "", "", true), "1.3.0", "Gregwar", "PHP", $licences[0]],
            ...
            [html_structures::a_link("https://js.cytoscape.org", "Cytoscape", "", "", true), "3.33.1", "The Cytoscape Consortium", "JS", $licences[10]],
            [html_structures::a_link("https://www.datatables.net", "Datatable", "", "", true), "2.3.8", "SpryMedia Limited", "JS", $licences[10]],
            ...
            [html_structures::a_link("https://github.com/dompdf/dompdf", "Dompdf", "", "", true), "3.1.5", "Benj Carson", "PHP", $licences[2]],
            ...
            [html_structures::a_link("https://studio-42.github.io/elFinder", "elFinder", "", "", true), "2.1.69", "Studio 42", "JS, PHP", $licences[3]],
            ...
            [html_structures::a_link("https://fullcalendar.io", "Fullcalendar", "", "", true), "6.1.21", "Adam Shaw", "JS", $licences[0]],
            [html_structures::a_link("https://github.com/googleapis/google-api-php-client", "Google OAuth SDK (PHP 8.1)", "", "", true), "2.19.0", "Google", "PHP", $licences[4]],
            ...
            [html_structures::a_link("https://microsoft.github.io/monaco-editor/", "Monaco editor", "", "", true), "0.55.1", "Microsoft", "JS", $licences[0]],
            [html_structures::a_link("https://github.com/paypal/PayPal-PHP-Server-SDK", "PayPal-PHP-Server-SDK", "", "", true), "2.2.0", "PAYPAL INC.", "PHP", $licences[10]],
            ...
            [html_structures::a_link("https://github.com/PHPMailer/PHPMailer", "Phpmailer", "", "", true), "7.1.1", "Marcus Bointon, Jim Jagielski, Andy Prevost, Brent R. Matzelle", "PHP", $licences[2]],
            ...
            [html_structures::a_link("https://github.com/stripe/stripe-php", "Stripe", "", "", true), "20.2.1", "Stripe, Inc", "PHP", $licences[0]],
            ...
            [html_structures::a_link("https://videojs.com/", "Videojs", "", "", true), "8.23.4", "Brightcove, Inc.", "JS", $licences[4]],
