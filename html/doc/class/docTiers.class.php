...
class docTiers {
    ...
    public function __construct() {
        ...
        html_structures::table(["Librairie", "Version", "Auteur", "Langage", "Licence"], [
            ...
            [html_structures::a_link("https://icons.getbootstrap.com", "Bootsrap Icons", "", "", true), "1.10.3", "Twitter, Inc.", "CSS", $licences[0]],
            [html_structures::a_link("https://bootswatch.com", "Bootswatch", "", "", true), "5.2.3", "Thomas Park", "CSS", $licences[0]],
            [html_structures::a_link("https://github.com/Gregwar/Captcha", "Captcha", "", "", true), "1.1.9", "Gregwar", "PHP", $licences[0]],
            [html_structures::a_link("https://ckeditor.com/ckeditor-4/", "Ckeditor", "", "", true), "4.20.1", "Frederico Knabben", "JS", $licences[1]],
            ...
            [html_structures::a_link("https://github.com/googleapis/google-api-php-client", "Google OAuth SDK (PHP 7.4)", "", "", true), "2.13.0", "Google", "PHP", $licences[4]],
            ...
            [html_structures::a_link("https://revealjs.com/", "Reveal", "", "", true), "4.4.0", "Hakim El Hattab", "JS", $licences[0]],
            ...
            [html_structures::a_link("https://videojs.com/", "Videojs", "", "", true), "7.21.1", "Brightcove, Inc.", "JS", $licences[4]],
