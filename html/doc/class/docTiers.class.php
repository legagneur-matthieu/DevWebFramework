...
class docTiers {
    ...
    public function __construct() {
        ...
        html_structures::table(["Librairie", "Version", "Auteur", "Langage", "Licence"], [
            ...
            [html_structures::a_link("https://js.cytoscape.org", "Cytoscape", "", "", true), "3.18.0", "The Cytoscape Consortium", "JS", $licences[10]],
            [html_structures::a_link("https://www.datatables.net", "Datatable", "", "", true), "1.10.23", "SpryMedia Limited", "JS", $licences[10]],
            ...
            [html_structures::a_link("https://studio-42.github.io/elFinder", "elFinder", "", "", true), "2.1.57", "Studio 42", "JS, PHP", $licences[3]],
            ...
            [html_structures::a_link("http://www.flotcharts.org", "Flot", "", "", true), "4.2.1", "IOLA and Ole Laursen", "JS", $licences[0]],
            ...
            [html_structures::a_link("https://fullcalendar.io", "Fullcalendar", "", "", true), "5.5.1", "Adam Shaw", "JS", $licences[0]],
            ...
            [html_structures::a_link("https://github.com/PHPMailer/PHPMailer", "Phpmailer", "", "", true), "6.2.0", "Marcus Bointon, Jim Jagielski, Andy Prevost, Brent R. Matzelle", "PHP", $licences[2]],
            ...
            [html_structures::a_link("https://revealjs.com/", "Reveal", "", "", true), "3.9.2", "Hakim El Hattab", "JS", $licences[0]],
