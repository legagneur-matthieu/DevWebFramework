...
/**Supprime l'entité*/public static function delete_by_id($id) { application::$_bdd->query("delete from fullcalendar_resource where id='" . application::$_bdd->protect_var((int)$id) . "';"); }
